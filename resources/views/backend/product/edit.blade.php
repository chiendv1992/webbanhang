                                    ...
                                    <select name="category">
                                        ...
                                        @foreach($category as $key=>$cate)
                                            @if($product->cate_id ==  $cate->id)
                                                <option value="{{$cate->id}}" selected="true">
                                                    {{$cate->name}}
                                                </option>
                                            @else
                    ...
                    <div class="box-content">
                        <fieldset>
                            <div class="control-group hidden-phone">
                                ...
                                <div class="controls">
                                    <textarea class="cleditor" id="textarea2" rows="3" name="description">{{ old('description',isset($product) ? $product['description'] : null) }}</textarea>
                                </div>
                            </div>
                            <div class="control-group hidden-phone">
